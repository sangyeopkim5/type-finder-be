...
// 노드 타입에 따라 다른 SVG 아이콘과 연결점을 렌더링하는 함수
      ...
      return (
        <>
          ...
          <div className="connection-shapes-left">
            <svg width="8" height="9" viewBox="0 0 12 14" fill="none" className="shape purple-triangle"><path d="M11.25 7L0 13.0622V0.937822L11.25 7Z" fill="#8237D9" /></svg>
            <svg width="8" height="9" viewBox="0 0 12 14" fill="none" className="shape green-triangle"><path d="M11.25 7L0 13.0622V0.937822L11.25 7Z" fill="#37D937" /></svg>
            <svg width="8" height="8" viewBox="0 0 13 12" fill="none" className="shape purple-circle"><circle cx="6.25" cy="6" r="6" fill="#8237D9" /></svg>
            <svg width="8" height="8" viewBox="0 0 16 15" fill="none" className="shape blue-square"><rect width="10.5015" height="10.5015" transform="matrix(0.711213 -0.702977 0.711213 0.702977 0.3125 7.61768)" fill="#009DFF" /></svg>
          </div>
          <div className="connection-shapes">
            <svg width="8" height="9" viewBox="0 0 12 14" fill="none" className="shape purple-triangle"><path d="M0.25 7L11.5 0.937822V13.0622L0.25 7Z" fill="#8237D9" /></svg>
            <svg width="8" height="9" viewBox="0 0 12 14" fill="none" className="shape green-triangle"><path d="M0.25 7L11.5 0.937822V13.0622L0.25 7Z" fill="#37D937" /></svg>
            <svg width="8" height="8" viewBox="0 0 13 12" fill="none" className="shape purple-circle"><circle cx="6.25" cy="6" r="6" fill="#8237D9" /></svg>
            <svg width="8" height="8" viewBox="0 0 16 15" fill="none" className="shape blue-square"><rect width="10.5015" height="10.5015" transform="matrix(0.711213 -0.702977 0.711213 0.702977 0.3125 7.61768)" fill="#009DFF" /></svg>
          </div>
        </>
        ...
        <>
          <div className="node-content">
            <svg width="54" height="54" viewBox="0 0 54 54" fill="none" className="compass-icon">
              ...
              <g mask="url(#mask0_104_956)"><path d="M61 -7H-7V61H61V-7Z" fill="currentColor" /></g>
            </svg>
            <div className="node-label">{node.label}</div>
          </div>
          <div className="connection-shapes-left">
          ...
          <div className="connection-shapes">
            <svg width="8" height="9" viewBox="0 0 12 14" fill="none" className="shape purple-triangle"><path d="M0.25 7L11.5 0.937822V13.0622L0.25 7Z" fill="#8237D9" /></svg>
            <svg width="8" height="9" viewBox="0 0 12 14" fill="none" className="shape green-triangle"><path d="M0.25 7L11.5 0.937822V13.0622L0.25 7Z" fill="#37D937" /></svg>
            <svg width="8" height="9" viewBox="0 0 12 14" fill="none" className="shape blue-triangle"><path d="M0.25 7L11.5 0.937822V13.0622L0.25 7Z" fill="#009DFF" /></svg>
            <svg width="8" height="8" viewBox="0 0 16 15" fill="none" className="shape blue-square"><rect width="10.5015" height="10.5015" transform="matrix(0.711213 -0.702977 0.711213 0.702977 0.3125 7.61768)" fill="#009DFF" /></svg>
          </div>
        </>
      );
    case 'visualization':
      return (
        <>
          ...
          <div className="connection-shapes">
            <svg width="8" height="9" viewBox="0 0 12 14" fill="none" className="shape orange-triangle"><path d="M0.25 7L11.5 0.937822V13.0622L0.25 7Z" fill="#FFA500" /></svg>
            <svg width="8" height="8" viewBox="0 0 16 15" fill="none" className="shape blue-square"><rect width="10.5015" height="10.5015" transform="matrix(0.711213 -0.702977 0.711213 0.702977 0.3125 7.61768)" fill="#009DFF" /></svg>
          </div>
        </>
      );
    case 'video':
      return (
        <>
          ...
          <div className="connection-shapes-left">
            <svg width="8" height="9" viewBox="0 0 12 14" fill="none" className="shape orange-triangle"><path d="M11.25 7L0 13.0622V0.937822L11.25 7Z" fill="#FFA500" /></svg>
            <svg width="8" height="9" viewBox="0 0 12 14" fill="none" className="shape green-triangle"><path d="M11.25 7L0 13.0622V0.937822L11.25 7Z" fill="#37D937" /></svg>
            <svg width="8" height="9" viewBox="0 0 12 14" fill="none" className="shape blue-triangle"><path d="M11.25 7L0 13.0622V0.937822L11.25 7Z" fill="#009DFF" /></svg>
          </div>
          <div className="connection-shapes">
            <svg width="8" height="8" viewBox="0 0 13 12" fill="none" className="shape orange-circle"><circle cx="6.25" cy="6" r="6" fill="#FFA500" /></svg>
            <svg width="8" height="8" viewBox="0 0 16 15" fill="none" className="shape blue-square"><rect width="10.5015" height="10.5015" transform="matrix(0.711213 -0.702977 0.711213 0.702977 0.3125 7.61768)" fill="#009DFF" /></svg>
          </div>
        </>
      );
    case 'summary':
      return (
        <>
          ...
          <div className="connection-shapes">
            <svg width="8" height="8" viewBox="0 0 13 12" fill="none" className="shape blue-circle"><circle cx="6.25" cy="6" r="6" fill="#009DFF" /></svg>
            <svg width="8" height="8" viewBox="0 0 16 15" fill="none" className="shape orange-square"><rect width="10.5015" height="10.5015" transform="matrix(0.711213 -0.702977 0.711213 0.702977 0.3125 7.61768)" fill="#FFA500" /></svg>
          </div>
        </>
      );
    default:
...
function Node({ node, onMouseDown }) {
  return (
    <div
      id={node.id}
      className={`canvas-node ${node.type}-node`}
